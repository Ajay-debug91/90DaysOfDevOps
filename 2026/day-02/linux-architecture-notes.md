...
Process Creation
fork() System Call: Creates a new child process by duplicating the parent process. The child gets a unique PID but inherits most of the parent's environment.
